<template>
  <div
    ref="containerRef"
    class="line-waves-container"
    :class="{ 'line-waves-interactive': enableMouseInteraction }"
    aria-hidden="true"
  />
</template>
...
.line-waves-container.line-waves-interactive {
  pointer-events: auto;
}
