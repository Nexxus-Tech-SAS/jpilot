<template>
  <div class="blueprint-suggestion" role="region" aria-label="Blueprint suggestion">
    <div class="blueprint-suggestion-header">
      <span class="blueprint-suggestion-icon" aria-hidden="true">
        <i class="pi pi-bolt" />
      </span>
      <span class="blueprint-suggestion-title">{{ suggestion.label }}</span>
      <span
        v-if="suggestion.confidence > 0"
    ...
    <p v-if="suggestion.summary" class="blueprint-suggestion-summary">
      {{ suggestion.summary }}
    </p>
