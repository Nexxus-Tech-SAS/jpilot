<template>
  <div
    ref="containerRef"
    class="soft-aurora-container"
    :class="{ 'soft-aurora-interactive': enableMouseInteraction }"
    aria-hidden="true"
  />
</template>
...
.soft-aurora-container.soft-aurora-interactive {
  pointer-events: auto;
}

.soft-aurora-container :deep(canvas) {
  display: block;
  width: 100%;
  height: 100%;
}
